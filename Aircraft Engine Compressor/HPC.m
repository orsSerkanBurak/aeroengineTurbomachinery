...
%% Aerodynamic Definition Calculations of HPC
D=0.5; % Diffusion factor
M1 = 0.32; % Fan input velocity in Mach #
gamma = 1.4; % Ratio of specific heats
sigma = 1; % Solidity of HPC
ec = 0.8954; % Polytropic efficiency of HPC
alpha1 = -90:0.01:90; % blade angle
...
grid on;
title('Repeating Compressor Stage(D=0.5,,M_{1}=0.32,\gamma =1.4,,\sigma=1,e_{c} = 0.8954)');
